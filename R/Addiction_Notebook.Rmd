...
library("MatchIt") 
```
#Es wurden die benötigten Packages installiert und geladen
#benötigter Datensatz wird anschließend geladen
```{r}
...
#Um die Daten komprimiert auszugeben wird hier die summary Funktion für den gematchen Datensatz angewendet.
